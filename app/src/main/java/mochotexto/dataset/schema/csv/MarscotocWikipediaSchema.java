...
@Setter
@ToString
@JsonPropertyOrder({"_name", "_industry", "_headquarters", "_founded", "_area_served"})
public class MarscotocWikipediaSchema implements CsvDatasetMapper {
